...
VIRUSTOTAL_POLL_INTERVAL_ERROR_MESSAGE = "Please provide a valid positive integer for 'Number of minutes to poll for a detonation result' \
    parameter."
VIRUSTOTAL_REQUESTS_PER_MINUTE_ERROR_MESSAGE = "Please provide a valid positive integer for 'Requests per minute' parameter."
VIRUSTOTAL_ERROR_MESSAGE = "Error occurred while connecting to the VirusTotal server. \
